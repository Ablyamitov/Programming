...
class Authorization():
    ...
    def __init__(self,main):
        ...
        #self.reg_rect = pygame.Rect(0,0,250,150)

        #self.reg_rect.midleft = self.screen_rect.midleft
    ...
    '''def show_cur(self):
        rect = pygame.Rect(self.settings.center_x-35,self.settings.center_y - self.settings.center_y/4,100,32)
        self.screen.blit(self.image_cur,rect)'''
